...
public class ManterUsuario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/novo.png"))); // NOI18N
    ...
    private void btAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAdicionarActionPerformed
        ...
        JDialog dialogo = new CadastroUsuario(telaPrincipal, true, usuDao);
        ...
        if (linha < 0) {
            ...
            if (Mensagens.perguntar("Tem certeza que deseja remover o Usuario " + us.getNome()) == 0) {
                try {
                    ...
                    this.usuDao.remover(us);

                } catch (SQLException ex) {
                    Mensagens.erro("Erro ao tentar remover o Usuário: " + ex.getMessage());
                }
            }
