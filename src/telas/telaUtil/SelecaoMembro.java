...
public class SelecaoMembro extends javax.swing.JDialog {

    private List<Membro> listaMem;
    private final MembroDAO memDao;
    private Membro membro = null;

    public SelecaoMembro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (linha < 0) {
            ...
            this.membro = listaMem.get(tabUsuario.getSelectedRow());
            dispose();
        }
    ...
    javax.swing.JTextField txtFone;
